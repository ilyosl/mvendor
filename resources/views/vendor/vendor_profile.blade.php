                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data" action="{{ route('vendor.profile.store') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea type="text" name="address" class="form-control">{{$vendorData->address}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="vendor_join" class="form-control" value="{{$vendorData->vendor_join}}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea type="text" rows="3" name="vendor_short_info" class="form-control">{{$vendorData->vendor_short_info}}</textarea>
                                        </div>
                                    </div>
