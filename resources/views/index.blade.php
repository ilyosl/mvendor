                        ...
                        <div class="col-md-3">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="change-password-tab" data-bs-toggle="tab" href="#change-password" role="tab" aria-controls="change-password" aria-selected="true"><i class="fi-rs-user mr-10"></i>Changes Password</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <form method="post" enctype="multipart/form-data" action="{{ route('user.profile.store') }}">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input required="" disabled class="form-control" name="email" type="email" value="{{ $userData->email }}" />
                                                    </div>
                                                    <div class="form-group col-md-12">
